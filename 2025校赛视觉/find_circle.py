...
class FindRectCircle:
    ...
    model_path = "/root/models/2025.7.30_15.34/model_3356.mud" # 检测黑框模型路径，从 https://maixhub.com/model/zoo/1159 下载并传到开发板的 /root/models 目录
    ...
    def find_laser_point(self, img, original_img):
        ...
        blobs = img.find_blobs(ths, x_stride=2, y_stride=2)
